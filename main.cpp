...
int main(int argc, char *argv[])
{
    ...
    tableTemplate.appendTitle({"img", "text","img"}, {":/assets/images/danet.png", "DaNet Report", ":/assets/images/danet.png"}, "Header-3",  {"", "#005", ""}, {"left", "center", "right"});
    ...
    tableTemplate.appendRow({"text", "img", "text", "text"}, {"samad",":/assets/images/tct.png", "test2", "test3"}, "650K NET", {0,0,0,0}, {0,0,0,0},{"#F00", "#F55", "#F33", "#F80"},{"center", "right", "center", "right"});
...
//    tableTemplate.appentRow();
    ...
    tableTemplate.appendRow({"text", "img", "text", "text"}, {"samad",":/assets/images/kuber.png", "Kuber", "test3"}, "Metro Plan-2",{0,0,0,0}, {0,0,0,0},{"#F00", "#F55", "#F33", "#F80"},{"center", "right", "center", "right"});

    tableTemplate.highlight(5);

    Exporter fileExporter(&tableTemplate);
    fileExporter.pdf("my-pdf.pdf",2,false,"Ghanbari","DaNet Report","A3");
